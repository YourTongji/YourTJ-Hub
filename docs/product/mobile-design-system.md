...
`Planned`: name, calendar and official timetable use a private device snapshot, with last successful
...
the account and snapshot age. The lifecycle and data boundaries belong in the

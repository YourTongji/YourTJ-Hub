...
import type { StatusSnapshot } from '@gooseforum/client'
import StatusUptime from '../src/site/components/status/StatusUptime.vue'
import { i18n, setLocale } from '../src/runtime/i18n'
const fixture = JSON.parse(readFileSync('../../../packages/api-contract/fixtures/status-connected.json', 'utf8')).result as StatusSnapshot

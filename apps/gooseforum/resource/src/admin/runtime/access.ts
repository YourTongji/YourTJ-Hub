...
const adminPathPermissions: Record<string, AdminPermission> = {
  ...
  '/admin/search': AdminPermission.SiteManager,
  '/admin/data': AdminPermission.SiteManager,
  ...
  '/admin/settings/rate-limit': AdminPermission.SiteManager,
  '/admin/settings/mcp': AdminPermission.SiteManager,
  '/admin/settings/ai-summary': AdminPermission.SiteManager,
  ...
  '/admin/settings/privacy': AdminPermission.SiteManager,
  '/admin/settings/onesystem': AdminPermission.SiteManager,
  '/admin/settings/schedule': AdminPermission.SiteManager,
  '/admin/settings/campus-calendar': AdminPermission.SiteManager,
...
const adminEntryPaths = [
  ...
  '/admin/settings/campus-calendar',

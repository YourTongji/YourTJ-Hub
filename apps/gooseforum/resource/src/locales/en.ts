...
export default {
  ...
  settings: {
    ...
    avatar: {
      ...
      preview: 'Preview',
      cropTip: 'Drag to reposition and use the slider to zoom. Final avatar exports at 300 × 300.',
    ...
    cover: {
      upload: 'Upload image',
      ratioHint: '5:1 landscape, at least 1200×240',
      orUrl: 'or use an image name or external link',
      urlPlaceholder: 'Image name or full link',
      coverUrlInvalid: 'Please enter a valid image name or link',
      uploading: 'Uploading...',
      confirmUpload: 'Upload',
      cropTitle: 'Crop cover',
      editTitle: 'Adjust image size and position',
      editHint: 'Drag to reposition, scroll or use buttons to zoom',
      ...
      cropDescription: 'Drag the selection to adjust the cover. Aspect ratio is 5:1.',

...
export default {
  ...
  schedule: {
    ...
    cellClickHint: 'Click "Select Courses" to add a course',
    exportEmpty: 'Nothing to export yet — pick courses into the list first',
    noAlternative: 'No alternative courses',
    noSearchResult: 'No courses match your search',
    pickerEmpty: 'No courses available',
    conflictCount: 'Conflicts with {count} courses',

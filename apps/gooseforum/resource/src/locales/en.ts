...
export default {
  ...
  coursesPage: {
    ...
    bannerTitle: 'Explore the best courses at Tongji University',
    ...
    quickHot: 'Popular picks',
    quickElective: 'Electives',
    recommendTitle: 'Recommended for you',
    recommendSubtitle: 'Based on popularity and ratings',
    shake: 'Shuffle',
    hotInstructors: 'Popular instructors',
    hotInstructorUnit: '{count} heat',
    viewAll: 'View all',
  ...
  schedule: {
    ...
    dropCourse: 'Drop',
    clear: 'Clear',
    noMajorSelected: 'Select a major first',
    conflictTitle: 'Schedule conflict',
    conflictWith: 'Conflicts with "{course}"',
    forceReplace: 'Replace anyway',
    abandon: 'Abandon',
    selectedCredit: 'Selected credits: {value}',
    majorCredit: 'Major credits: {value}',
    generalCredit: 'General credits: {value}',
    creditNote: 'Major classification may be imprecise due to incomplete records',
    creditSummary: 'Credits',
    dataOutdated: 'Course data may be outdated',
    ...
    detail: 'Details',
    arrangedCount: '{count} classes arranged',
    gradeUnit: 'Grade {grade}',

...
export default {
  ...
  settings: {
    ...
    content: {
      ...
      batchConfirmDescription: 'You are deleting many items in a short time ({count} this time). This might be a mistake or a compromised account. Continue?',
      batchConfirmContinue: 'Continue deleting',
    },
    status: {

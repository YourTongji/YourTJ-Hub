...
export default {
  ...
  settings: {
    ...
    avatar: {
      ...
      preview: 'プレビュー',
      cropTip: 'ドラッグで位置を調整し、スライダーで拡大縮小します。最終アバターは 300 × 300 で出力されます。',
      cropAlt: 'アバタープレビュー',
      zoomIn: '拡大',
      zoomOut: '縮小',
      zoomSlider: 'ズーム',
    ...
    cover: {
      upload: '画像をアップロード',
      ratioHint: '5:1 横長、最低 1200×240',
      orUrl: 'または画像名・外部リンクを入力',
      urlPlaceholder: '画像名または完全なリンク',
      coverUrlInvalid: '有効な画像名またはリンクを入力してください',
      cropTitle: 'カバーをトリミング',
      editTitle: '画像のサイズと位置を調整',
      editHint: '画像をドラッグして位置を調整、ホイールまたはボタンでズーム',

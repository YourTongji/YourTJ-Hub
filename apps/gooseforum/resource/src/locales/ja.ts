...
export default {
  ...
  schedule: {
    ...
    cellClickHint: '「履修を選択」から科目を追加できます',
    exportEmpty: 'エクスポートできる科目がありません。まず科目を選択してください',
    noAlternative: '候補の科目がありません',
    noSearchResult: '条件に一致する科目がありません',
    pickerEmpty: '利用可能な科目がありません',
    conflictCount: '{count} 件の科目と衝突',

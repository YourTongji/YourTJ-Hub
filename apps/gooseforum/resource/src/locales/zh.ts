...
export default {
  ...
  settings: {
    ...
    avatar: {
      ...
      preview: '预览',
      cropTip: '拖动图片调整位置，使用滑条缩放。最终头像导出为 300 × 300。',
      cropAlt: '头像预览',
      zoomIn: '放大',
      zoomOut: '缩小',
      zoomSlider: '缩放',
    ...
    cover: {
      upload: '上传图片',
      ratioHint: '推荐 5:1 横图，至少 1200×240',
      orUrl: '或填写图片名称或外部链接',
      urlPlaceholder: '图片名称或完整链接',
      coverUrlInvalid: '请输入有效的图片名称或链接',
      uploading: '上传中...',
      confirmUpload: '确认上传',
      cropTitle: '裁剪封面',
      editTitle: '调整图片尺寸与位置',
      editHint: '拖动图片调整位置，滚轮或按钮缩放',
      mobileCropHint: '遮罩覆盖区域在移动端设备上可能会被裁切',
      zoomIn: '放大',
      zoomSlider: '缩放',
      zoomOut: '缩小',
      minSizeRequired: '请上传宽度大于 {width}px、高度大于 {height}px 的封面图片。',
      cropDescription: '拖动选区调整封面范围，比例为 5:1。',
      previewDesktop: '桌面预览',
      previewMobile: '移动预览',
      cropTip: '封面会展示在个人主页顶部：桌面端 5:1 全幅，移动端 3:1 居中裁切两侧。请使用宽度 ≥ 1200px、高度 ≥ 240px 的横向图片，主体居中。',
    },
    security: {
      title: '登录设备',

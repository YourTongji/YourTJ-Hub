              ...
              <div class="min-w-0">
                <div class="mb-1.5 flex min-w-0 items-start justify-between gap-2">
                  ...
                  <div class="flex shrink-0 items-center gap-0.5 sm:gap-1.5">
                    ...
                    <button
                      v-if="page.props.permissions.canPost && !group.root.isHidden && !isPostRemoved(group.root)"
                      type="button"
                ...
                <div v-if="group.replies.length" class="mt-4 space-y-2 border-t border-line pt-3">
                  ...
                  >
                    ...
                    <div class="mt-2 flex items-center gap-1">
                      <button
                        v-if="page.props.permissions.canPost && !reply.isHidden && !isPostRemoved(reply)"
                        type="button"

    ...
    <section class="gf-card overflow-hidden">
      ...
      <div v-if="notifications.length" class="divide-y divide-line">
        <article
          ...
          :key="item.id"
          class="relative grid grid-cols-[34px_minmax(0,1fr)] items-center gap-3 px-3 py-2.5 transition-[background-color] hover:bg-base-200/70 md:grid-cols-[34px_minmax(0,1fr)_116px_40px] md:items-start"

...
const standaloneComponents = new Set(['auth.login', 'auth.resetPassword', 'campus.map'])
const keepAliveComponents = new Set(['home.index', 'category.index', 'search.index', 'course.index'])

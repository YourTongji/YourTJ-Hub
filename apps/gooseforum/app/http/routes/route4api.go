...
func apiRoute(ginApp *gin.Engine) {
	...
	agentApi.GET("inbox", UpQueryReq(api.AgentInboxList))
	agentApi.GET("inbox/:inboxId", UpUriReq(api.AgentInboxDetail))
	agentApi.POST("inbox/:inboxId/read", UpUriReq(api.AgentInboxRead))
	agentApi.POST("inbox/read-all", UpButterReq(api.AgentInboxReadAll))
	agentApi.DELETE("inbox/:inboxId", UpUriReq(api.AgentInboxDelete))
	agentApi.DELETE("inbox", UpButterReq(api.AgentInboxClear))

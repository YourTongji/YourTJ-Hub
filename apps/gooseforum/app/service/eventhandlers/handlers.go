...
func Handlers() []cqrs.EventHandler {
	return []cqrs.EventHandler{
		...
		cqrs.NewEventHandler("LLMSCommentCreatedHandler", handleLLMSCommentCreated),
		cqrs.NewEventHandler("LLMSCategoryUpdatedHandler", handleLLMSCategoryUpdated),
		cqrs.NewEventHandler("LLMSCategoryDeletedHandler", handleLLMSCategoryDeleted),

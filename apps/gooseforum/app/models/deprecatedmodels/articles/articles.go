...
type Entity struct {
	...
	RenderedVersion uint32         `gorm:"column:rendered_version;not null;default:0;" json:"renderedVersion"`                                                                                                                                                                                                                                                  //md 的渲染器版本
	Type            int8           `gorm:"column:type;not null;default:0;" json:"type"`                                                                                                                                                                                                                                                                         // 文章类型：0 博文，1教程，2问答，3分享
	CategoryId      []uint64       `gorm:"column:category_id;type:varchar(255);not null;default:'[]';serializer:json" json:"categoryId"`                                                                                                                                                                                                                        // 分类
	UserId          uint64         `gorm:"column:user_id;not null;default:0;index:idx_user_status;index:idx_user_published_id,priority:1;" json:"userId"`                                                                                                                                                                                                       //
	Posters         []Poster       `gorm:"column:posters;type:text;serializer:json" json:"posters"`
	ArticleStatus   int8           `gorm:"column:article_status;not null;default:0;index:idx_user_status;index:idx_user_published_id,priority:2;index:idx_articles_list_default,priority:1;index:idx_articles_list_hot,priority:1;index:idx_articles_list_popular,priority:1;index:idx_articles_list_new,priority:1;" json:"articleStatus"` // 文章状态：0 草稿 1 发布
	ProcessStatus   int8           `gorm:"column:process_status;not null;default:0;index:idx_user_status;index:idx_user_published_id,priority:3;index:idx_articles_list_default,priority:2;index:idx_articles_list_hot,priority:2;index:idx_articles_list_popular,priority:2;index:idx_articles_list_new,priority:2;" json:"processStatus"` // 管理状态：0 正常 1 封禁
	LikeCount       uint64         `gorm:"column:like_count;not null;default:0;" json:"likeCount"`                                                                                                                                                                                                                                          // 喜欢数量
	ViewCount       uint64         `gorm:"column:view_count;not null;default:0;index:idx_articles_list_popular,priority:3,sort:desc;" json:"viewCount"`                                                                                                                                                                                     // 访问数量
	ReplyCount      uint64         `gorm:"column:reply_count;not null;default:0;index:idx_articles_list_hot,priority:3,sort:desc;" json:"replyCount"`                                                                                                                                                                                       // 评论数量
	ReplySeq        uint64         `gorm:"column:reply_seq;not null;default:0;" json:"replySeq"`                                                                                                                                                                                                                                            // 历史最大回复序号
...
type SmallEntity struct {
	...
	Posters       []Poster       `gorm:"column:posters;type:text;serializer:json" json:"posters"`
	ArticleStatus int8           `gorm:"column:article_status;not null;default:0;" json:"articleStatus"`  // 文章状态：0 草稿 1 发布
	ProcessStatus int8           `gorm:"column:process_status;not null;default:0;" json:"processStatus"`  // 管理状态：0 正常 1 封禁
	ViewCount     uint64         `gorm:"column:view_count;not null;default:0;" json:"viewCount"`          // 访问数量
	ReplyCount    uint64         `gorm:"column:reply_count;not null;default:0;" json:"replyCount"`        // 评论
	ReplySeq      uint64         `gorm:"column:reply_seq;not null;default:0;" json:"replySeq"`            // 历史最大回复序号
	LikeCount     uint64         `gorm:"column:like_count;not null;default:0;" json:"likeCount"`          // 被喜欢

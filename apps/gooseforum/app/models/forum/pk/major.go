...
type MajorEntity struct {
	...
	Audience      string         `gorm:"column:audience;type:varchar(32);not null;default:'undergraduate';index:idx_pk_major_audience;uniqueIndex:uniq_pk_major_name,priority:1;" json:"audience"`
	...
	Name          string         `gorm:"column:name;type:varchar(255);not null;default:'';uniqueIndex:uniq_pk_major_name,priority:2;" json:"name"`

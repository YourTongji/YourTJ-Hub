...
type Entity struct {
	...
	UserId         uint64    `gorm:"column:user_id;not null;default:0;index:idx_user_activity_id,priority:1;index:idx_user_activity_created;" json:"userId"` // 发起者 ID
	...
	SubjectId      uint64    `gorm:"column:subject_id;not null;default:0;" json:"subjectId"`                                                                 // 目标 ID

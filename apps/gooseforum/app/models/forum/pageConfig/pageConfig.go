...
type OneSystemSettingsConfig struct {
	CookieEncrypted         string `json:"-"` // 加密后的本科一系统 Cookie header
	GraduateXTokenEncrypted string `json:"-"` // 加密后的研究生一系统 X-Token
	GraduateCookieEncrypted string `json:"-"` // 旧版研究生 Cookie 密文，兼容存量配置
}
...
type OneSystemSettingsStorage struct {
	CookieEncrypted         string `json:"cookieEncrypted,omitempty"`
	GraduateXTokenEncrypted string `json:"graduateXTokenEncrypted,omitempty"`
	GraduateCookieEncrypted string `json:"graduateCookieEncrypted,omitempty"` // 旧版兼容
}
...
func (s OneSystemSettingsStorage) ToConfig() OneSystemSettingsConfig {
	return OneSystemSettingsConfig{
		...
		GraduateXTokenEncrypted: s.GraduateXTokenEncrypted,

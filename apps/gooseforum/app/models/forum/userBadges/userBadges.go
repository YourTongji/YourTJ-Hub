...
type Entity struct {
	...
	UserId    uint64     `gorm:"column:user_id;not null;default:0;uniqueIndex:idx_user_badge_code;index:idx_user_badge_granted;" json:"userId"`
	...
	GrantedBy uint64     `gorm:"column:granted_by;not null;default:0;" json:"grantedBy"`
	GrantedAt time.Time  `gorm:"column:granted_at;index:idx_user_badge_granted;" json:"grantedAt"`
	RevokedAt *time.Time `gorm:"column:revoked_at;index;" json:"revokedAt"`

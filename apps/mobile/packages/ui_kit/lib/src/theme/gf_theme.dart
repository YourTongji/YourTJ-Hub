...
abstract final class GfTheme {
  ...
  /// The [GfShadows] tokens registered by `gfThemeData`.
  static GfShadows shadowsOf(BuildContext context) {
    return Theme.of(context).extension<GfShadows>() ?? GfShadows.standard;
  }
